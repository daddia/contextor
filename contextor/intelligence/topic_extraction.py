...
class TopicExtractor:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.stop_words = {
            ...
            "so", "than", "too", "very", "just", "now", "here", "there", "when", "where",
            "why", "how", "what", "which", "who", "whom", "whose", "if", "then", "else"
        }
    ...
    def extract_topics(
        ...
        path_topics = self._extract_from_path(metadata.get("source", {}).get("path", ""))
    ...
    def _extract_from_keywords(self, content: str) -> List[str]:
        ...
        topics = [
            ...
            if freq >= self.min_topic_frequency
        ]

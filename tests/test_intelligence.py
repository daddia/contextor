...
"""
        ...
        metadata = {"title": "Complete Guide", "fetched_at": "2025-01-27T10:30:00Z"}
...
"""
        ...
        incompleteness = scorer._score_completeness(
    ...
    def test_score_freshness(self):
        ...
        # Recent document (use current date)
        from datetime import datetime

        recent_date = datetime.now(UTC).isoformat().replace("+00:00", "Z")
        recent_metadata = {"fetched_at": recent_date}
...
class TestSimilarityAnalyzer:
    ...
    def test_generate_content_vector(self):
        ...
        content = (
            "This is a test document with some repeated words. Test document example."
        )
...
class TestCrossLinker:
    ...
    def test_find_related_documents(self):
        ...
        linker = CrossLinker(config={"relevance_threshold": 0.2})
        ...
        # Use a threshold that will find the React relationship
        # (calculated relevance is ~0.175 based on topic overlap)
        linker.relevance_threshold = 0.15
    ...
    def test_calculate_path_similarity(self):
        ...
        doc1 = {"metadata": {"source": {"path": "docs/react/hooks.md"}}}

        doc2 = {"metadata": {"source": {"path": "docs/react/components.md"}}}

        doc3 = {"metadata": {"source": {"path": "docs/python/basics.md"}}}
...
class TestIntelligenceAnalyzer:
    ...
    def test_filter_files_for_analysis(self, temp_source_dir):
        ...
        incremental_files = analyzer._filter_files_for_analysis(
            mdc_files, incremental=True
        )
...
class TestIntelligenceIntegration:
    ...
    def test_cli_integration(self, temp_source_dir):
        ...
        with patch("contextor.intelligence.IntelligenceAnalyzer") as mock_analyzer:
            mock_instance = Mock()
            ...
            result = runner.invoke(
                ...
                [
                    ...
                    str(temp_source_dir),
                    "--features",
                    "topic-extraction,quality-scoring",
                ],
            )
